...
Bootstraps a concurso structure in the Obsidian vault at `/Users/luizgustavo/git/vault`. Extracts the full syllabus from the edital, deduplicates overlapping topics, and produces orthogonal (non-redundant) subject files.
